...
class ModelPriceList(BaseModel):
    """
    ModelPriceList
    """ # noqa: E501
    providers: Optional[List[ModelPrice]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [ModelPrice.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
        return _obj
