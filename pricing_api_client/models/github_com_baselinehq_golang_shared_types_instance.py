...
class GithubComBaselinehqGolangSharedTypesInstance(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["availability_zone", "fallback_to_base_pricing", "id", "instance_type", "operating_system", "provider", "region", "service", "usage_type", "vm"]
