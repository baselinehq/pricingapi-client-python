...
if TYPE_CHECKING:
    from ..models.types_disk import TypesDisk
    from ..models.types_predicates import TypesPredicates


T = TypeVar("T", bound="TypesDiskRequest")


@_attrs_define
class TypesDiskRequest:
    """
    Attributes:
        include_metadata (bool | Unset):
        instance (TypesDisk | Unset):
        predicates (TypesPredicates | Unset):
        usage (TypesDisk | Unset):
    """

    include_metadata: bool | Unset = UNSET
    instance: TypesDisk | Unset = UNSET
    predicates: TypesPredicates | Unset = UNSET
    usage: TypesDisk | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_instance, Unset):
            ...
            instance = TypesDisk.from_dict(_instance)
        ...
        if isinstance(_usage, Unset):
            ...
            usage = TypesDisk.from_dict(_usage)

        types_disk_request = cls(
        ...
        types_disk_request.additional_properties = d
        return types_disk_request
