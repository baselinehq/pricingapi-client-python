...
class TypesMarketplaceProvidersResponse(BaseModel):
    """
    TypesMarketplaceProvidersResponse
    """ # noqa: E501
    providers: Optional[List[SchemaComputePricingsRow]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [SchemaComputePricingsRow.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
        return _obj
