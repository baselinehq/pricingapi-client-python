...
class RegisteredDatabasePrices(BaseModel):
    """
    RegisteredDatabasePrices
    """ # noqa: E501
    entries: Optional[List[DatabasePrice]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [DatabasePrice.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
