# pricing-api-client
A client library for accessing Pricing API

## Usage
First, create a client:

```python
from pricing_api_client import Client
...
```python
from pricing_api_client.models import MyDataModel
from pricing_api_client.api.my_tag import get_my_data_model
from pricing_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `pricing_api_client.api.default`
